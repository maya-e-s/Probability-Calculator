...
Completed Probability Calculator project from freeCodeCamp: Scientific Computing with Python. Details about the project can be found at [freecodecamp.org/learn/scientific-computing-with-python](https://www.freecodecamp.org/learn/scientific-computing-with-python/scientific-computing-with-python-projects/probability-calculator).
